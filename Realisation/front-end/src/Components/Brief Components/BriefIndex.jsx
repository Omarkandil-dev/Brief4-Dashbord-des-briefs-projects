...
const BriefIndex = (props) => {
  const { BriefInfo, getBriefInfo, deleteBrief } = useContext(BriefContext);
  useEffect(() => {
    getBriefInfo();
  }, []);
